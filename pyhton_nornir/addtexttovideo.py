...
#txt_mov = my_text.set_pos('center').set_duration(15) 

final = mp.CompositeVideoClip([my_video,txt_mov])

#final.subclip(0,15).write_videofile('/home/majid/Downloads/testfps10.mp4',bitrate='3391k', fps=10,codec='libx264')
